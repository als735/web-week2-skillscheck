...
const groceries = ["lettuce", "tomatoes", "bacon"]; 
...
function checkGroceryCount(items) {
   let totalNum = groceries.length; 
    if (totalNum >= 5) {
        return `That looks like a big trip, don't take your scooter!`
    } else if (totalNum === 1) {
        return `1 item`
    } else if (totalNum === 2 || totalNum === 3 || totalNum === 4) {
